  ...
  return (
    <Card className="bg-slate-950/50">
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm text-slate-400">Connect cloud APIs, local runtimes, or compatible gateways.</p>
      </div>
      <form
      ...
      >
        ...
        <Button type="submit">{mutation.isPending ? "Saving..." : "Save provider"}</Button>
      </form>
    </Card>
  );
}
